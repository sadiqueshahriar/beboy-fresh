...
<meta name="description" content="{{$subcategory->meta_des ?? ''}}">
<meta property="keywords" content="{{$subcategory->meta_keywords ?? ''}}" />
<meta property="site_name" content="Binarylogic" />
<meta property="slug" content="{{ 'https://binarylogic.biz/'.$subcategory->slug ?? ''}}" />
@endsection
            ...
            <div class="row gx-5">
                ...
                <div class="col-md-9">
                    ...
                    <div class="row g-4 SubCategoryFilterProduct" id="SubCategoryFilterProduct">
                        ...
                        @empty
                        <h1 style="color: red">NO {{$subcategory->name ?? ''}} PRODUCT FOUND !!</h1>
                        @endforelse
                    </div>
                    <!-- end of row -->
                    <p>{{$products->links()}}</p>
