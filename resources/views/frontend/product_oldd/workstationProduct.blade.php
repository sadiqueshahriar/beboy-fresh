            ...
            <div class="container">
                <div class="row gx-5">
                    ...
                    <div class="col-md-9">
                        <div class="controller">
                            <form class="clearfix">
                                <div class="float-end">
                                    ...
                                    <select class="fz-small py-1 px-3" name="filterValue" id="filterValue" onchange="StationFilterProduct(this)">
                        ...
                        <!-- end of controller -->
                        <div class="row g-4 StationFilterProduct" id="StationFilterProduct">
                                    ...
                                    <div class="p-3 ">
                                        ...
                                        @else
                                            <div class="text-center align-items-center my-3">
                                                ...
                                                <strong class="fz-normal d-inline-block me-3" style="color: gray">Regular Price: ৳ {{$product->regular_price}}</strong>
                                                @endif
                                        ...
                                        <div class="card__icons align-items-center">
                                            ...
                                            <button type="button" class="button button-type-1  button-icon w-100 h-100 open-product-details-popup" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="{{$product->product_id}}">
...
<script type="text/javascript">
    ...
    var shop_type_id = <?php echo $shop_type->id; ?>;
    function StationFilterProduct(product){
        var $this = $(this);
        var id = shop_type_id;
        console.log(id);
        ...
        if (id) {
            $.ajax({
                url: "{{url('/filter-shop-type-products/')}}/"+id+"/"+filterValue,
                type: "GET",
                dataType: "json",
                beforeSend: function() {
                ...
                error:function(error){
                    // console.error(error);
                    $('.StationFilterProduct').html(error.responseText);
                }
            })
        }
    }
