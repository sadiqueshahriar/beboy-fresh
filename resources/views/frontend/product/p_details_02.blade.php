                            ...
                            <div class="col-md-5 mt-0 mt-md-4">
                                <div class="product-image">
                                    <div class="product-icons">
                                        ...
                                        <!--    <button class="button button-icon"><i class="fal fa-heart"></i></button>-->
                                        <!--</form>-->
                                    </div>
                                    
                                    <!--<div class="all-share-icons">-->
                                    <!--    <a href="#" class="all-share-icons__item">-->
                                    <!--        <img src="{{asset('public/frontend/img/facebook.png')}}" class="" />-->
                                    <!--    </a>-->
                                    <!--    <a href="#" class="all-share-icons__item">-->
                                    <!--        <img src="{{asset('public/frontend/img/twitter.png')}}" class="" />-->
                                    <!--    </a>-->
                                    <!--    <a href="#" class="all-share-icons__item">-->
                                    <!--        <img src="{{asset('public/frontend/img/google-plus.png')}}" class="" />-->
                                    <!--    </a>-->
                                    <!--    <a href="#" class="all-share-icons__item">-->
                                    <!--        <img src="{{asset('public/frontend/img/whatsapp.png')}}" class="" />-->
                                    <!--    </a>-->
                                    <!--    <a href="#" class="all-share-icons__item">-->
                                    <!--        <img src="{{asset('public/frontend/img/twitter.png')}}" class="" />-->
                                    <!--    </a>-->
                                    ...
                                    <div class="product-thumb-slider product-thumb">
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="slider-item swiper-slide border" >
                                                <img src="{{asset($image->product_image_thumb ?? $image->product_image)}}" alt="{{$image->product_image_alt}}" class="w-100 h-100" data-large-image="{{asset($image->product_image)}}" longdesc="{{$image->product_image_des}}">
                                            </div>
                                            @endforeach
                                        </div>
                                        <!--/.swiper-wrapper-->
                            ...
                            <div class="col-md-7">
                                <div class="p-4 p-md-0">
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <!--    <p class="product-price mb-3 pt-5 pt-md-4" style="color: {{$backgrounds->pd_text_color ?? ''}}"><span style="font-size: 23px">Offer Price:</span> ৳ <span class="number">{{number_format($product->offer_price)}}</span></p>-->
                                        <!--@else-->
                                        
                                        <!--    @if($product->special_price > 0)-->
        
                                        <!--    <p class="product-price mb-3 pt-5 pt-md-4" style="color: {{$backgrounds->pd_text_color ?? ''}}">Special Price: ৳ <span class="number">{{number_format($product->special_price)}}</span></p>-->
                                    ...
                                    <!--    <p class="fz-small fw-bold mb-0" style="color: {{$backgrounds->pd_text_color ?? ''}}; background: #086f7ee0; padding: 2px 3px;">Product Highlights</p>-->
                                    <!--    <p>{!!$product->product_highlights !!}</p>-->
                                    <!--</div>-->

                                    <!--<div class="mt-4" style="color: {{$backgrounds->pd_text_color ?? ''}}">-->
                                    <!--    <p class="fz-small fw-bold mb-0" style="color: {{$backgrounds->pd_text_color ?? ''}};background: #c43232e0; padding: 5px 10px;">Note</p>-->
                                    <!--    <p>{!!$product->note!!}</p>-->
                                    <!--</div>-->

                                    <!--<div class="mt-4" style="color: {{$backgrounds->pd_text_color ?? ''}}">-->
                                    <!--    <p class="fz-small fw-bold mb-0" style="color: {{$backgrounds->pd_text_color ?? ''}}; background: #326e9f; padding: 5px">Warranty </p>-->
                                    <!--    <p>{{$product->warranty ?? ''}}</p>-->
                                    <!--</div>-->

                                    @if(count($ProductHighlights)>0 || $product->product_highlights)
                                    <div class="mt-4 all-text-white" style="font-size: 14px;">
                                        <p class="fz-small fw-bold mb-0" style="color: #fff; background: #086f7ee0; padding: 5px 10px;">Product Highlights</p>
                                    ...
                                    @endif
                                    <!--<div class="mt-4" style="color: {{$backgrounds->pd_text_color ?? ''}}">-->
                                    <!--    <p class="fz-small fw-bold mb-0" style="color: #fff;background: #c43232e0; padding: 5px 10px;">Note</p>-->
                                    <!--    <p>{!!$product->note!!}</p>-->
                                    <!--</div>-->
                                    ...
                                    <div class="mt-4">
                                        <p class="fz-small fw-bold mb-4" style="color: #fff; background-color: var(--bs-success); padding: 5px 10px;">Monthly EMI</p>
                                    ...
                                    <div class="mt-4" style="color: {{$backgrounds->pd_text_color ?? ''}}">
                                        <p class="fz-small fw-bold mb-0" style="color: #fff; background: #326e9f; padding: 5px">Warranty </p>
                                    ...
                                    <div class="mt-4" style="color: {{$backgrounds->pd_text_color ?? ''}}">
                                        <p class="fz-small fw-bold mb-0" style="color: #fff; background: var(--bs-success); padding: 5px">Home Delivery : @if($product->home_delivery==1)Available @endif</p>
                                    </div>
                                    @endif

                                    @if(count($FreeItemForClients)>0)
                                    <div class="free-products mt-3">
                                        <p class="fz-small fw-bold mb-0" style="color: #fff; background: #9d6809; padding: 5px 10px;">Get Free</p>
                                        <div class="row g-3 mt-2">
                                            
                                            @foreach($FreeItemForClients as $FreeItemForClient )
                                            <div class="col-2">
                                                <a href="{{asset($FreeItemForClient->free_item_image)}}" class="free-products-thumb bg-light p-2" title="{{$FreeItemForClient->free_item_title}}"><img src="{{asset($FreeItemForClient->free_item_thumb ?? $FreeItemForClient->free_item_image)}}" alt="{{$FreeItemForClient->free_item_alt}}" ></a>
                                            </div>
                                            @endforeach
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <h1 class="text-light"> {{$siteSetting->phone ?? ''}}</h1>
                                    </div>
                                    ...
                                    <p class="mb-0 fz-small mt-3" style="color: {{$backgrounds->pd_text_color ?? ''}}">CATEGORIES:
                                    ...
                                    <p class="fz-extra-small text-light" style="color: {{$backgrounds->pd_text_color ?? ''}}" itemprop="Brand">BRANDS:
                                                    ...
                                                    <div class="card card-type-2">
                                                        ...
                                                        <div class="card__image" style="max-height: 20rem">
                                                            <a href="{{route('/', [$product->slug])}}">
                                                                <img src="{{asset($product->product_image_small ?? $product->image)}}" alt="{{$product->image_alt}}" longdesc="{{$product->image_des}}" class="card__image" style="max-height: 21rem">
