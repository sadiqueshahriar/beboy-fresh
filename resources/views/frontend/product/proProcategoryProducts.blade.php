...
@section('head')
<title>{{$proprocategory->meta_title ?? ''}}</title>
<meta name="title" content="{{$proprocategory->meta_title ?? ''}}">
<meta name="description" content="{{$proprocategory->meta_des ?? ''}}">
<meta property="keywords" content="{{$proprocategory->meta_keywords ?? ''}}" />
<meta property="site_name" content="Binarylogic" />
<meta property="slug" content="{{ 'https://binarylogic.com.bd/'.$proprocategory->slug ?? ''}}" />
<meta property="image" content="{{ 'https://binarylogic.com.bd/'.$proprocategory->image ?? ''}}">


<meta property="og:url"           content="{{ 'https://binarylogic.com.bd/'.$proprocategory->slug ?? ''}}" />
<meta property="og:type"          content="category" />
<meta property="og:title"         content="{{$proprocategory->meta_title ?? ''}}" />
<meta property="og:description"   content="{{$proprocategory->meta_des ?? ''}} " />
<meta property="og:keywords"   content="{{$proprocategory->meta_keywords ?? ''}} " />
<meta property="og:image" content="{{ 'https://binarylogic.com.bd/'.$proprocategory->image ?? ''}}">

<meta name="twitter:card" content="summary" />
<meta name="twitter:site" content="@BinaryLogic" />
<meta name="twitter:creator" content="@BinaryLogic" />
<meta property="twitter:url" content="{{ 'https://binarylogic.com.bd/'.$proprocategory->slug ?? ''}}" />
<meta property="twitter:title" content="{{$proprocategory->meta_title ?? ''}}" />
<meta property="twitter:description" content="{{$proprocategory->meta_des ?? ''}}" />
<meta property="og:keywords"   content="{{$proprocategory->meta_keywords ?? ''}} " />
<meta property="twitter:image" content="{{ 'https://binarylogic.com.bd/'.$proprocategory->image ?? ''}}" />
                    ...
                    <div class="controller">
                        <div class="clearfix">
                            <div class="float-start">
                                <h1 class="fz-large fw-bold mb-0" style="padding: 4px 0;">{{$proprocategory->name ?? ''}}</h1>
                            </div>
...
<script type="text/javascript">
    var category_id = <?php echo $proprocategory->category_id; ?>;
    var subcategory_id = <?php echo $proprocategory->subcategory_id; ?>;
    var prosubcategory_id = <?php echo $proprocategory->pro_sub_category_id; ?>;
