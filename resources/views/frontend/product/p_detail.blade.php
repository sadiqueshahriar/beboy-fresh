...
<meta property="ia:markup_url" content="{{ 'https://binarylogic.biz/'.$product->slug ?? ''}}">
<meta property="ia:rules_url" content="{{ 'https://binarylogic.biz/'.$product->slug ?? ''}}">
            ...
            <div class="row gx-4">
                ...
                <div class="col-lg-9">
                    <div class="row g-4">
                        ...
                        @endif
                        <div class="col-lg-6">
                            <h5 class="product-name fw-bold">{{$product->name}}
                                @if(!empty($admin_user))
                                @if($admin_user->role_id==0)
                                <a href="{{URL::to('admin/product/'.$product->id.'/edit')}}"><span style="color: blue"><i class="fas fa-pencil-alt"></i></span> </a>
                                @endif
                            ...
                            <h5 class="text-sky-blue pb-4 border-bottom mb-4">
                                ...
                                @if($product->call_for_price)
                                    <h3> {{$product->call_for_price}}</h3> <br>
                                @else
                                    @if($product->regular_price != '')

                                        <p style="font-size: 18px"><span style="color: #fff;border: 1px solid;background: #000;font-weight: 600;padding: 5px 20px;"> Regular Price: ৳ {{number_format($product->regular_price)}}</span><br>

                                    @endif

                                    @if($product->special_price != '')
                                        <span style="color: #fff;border: 1px solid;background: #ffa500;font-weight: 600;padding: 5px 20px;">Special Price: <b>৳ {{number_format($product->special_price)}}</b></span><br>
                                    @endif
                            ...
                            <p class="fz-small mb-4" style="border: 1px solid;background: #146b96; color: white;font-weight: 600;padding: 5px 20px;">PRODUCT HIGHLIGHTS {!!$product->product_highlights !!}</p>
                            @if(!empty($product->warranty))

                            <p class="fz-small mb-4"> <span style="color: #146b96;font-weight: 800;">WARRANTY</span>{{$product->warranty ?? ''}}</p>
                            ...
                            <div class="mb-4">
                                ...
                                <form action="{{route('add-to-wishlist')}}" class="d-inline-block" method="post">
                                    ...
                                    <input type="hidden" min="1" value="{{$product->id}}" class="fz-normal" name="product_id">
                                    <input type="hidden" min="1" value="1" class="fz-normal" name="qty">
                                    <button class="button button-type-1">WISH LIST</button>
                                </form>                                
                            ...
                            @endif
                            <div class="mb-4">
                                <strong class="fz-small me-5">SHARE</strong>
                                            ...
                                            <div class="card card-type-2">
                                                ...
                                                <div class="p-3 ">
                                                    ...
                                                    <div class="text-center align-items-center my-3">
                                                        ...
                                                        @endif
                                                        <strong class="fz-normal d-inline-block text-danger">Special Price: ৳ {{number_format($product->special_price)}}</strong> <br>
                                                    </div>
                                                    @endif
