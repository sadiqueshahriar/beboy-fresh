		              ...
		              <form class="form-horizontal" action="{{URL::to('admin/category')}}" method="post" enctype="multipart/form-data">
		                ...
		                <div class="card-body">
						  ...
						  <div class="form-group row">
		                    ...
		                    <div class="col-sm-12">
		                      <textarea name="description" class="textarea form-control" rows="5"></textarea>
		                    </div>
		                  </div>
		                  ...
		                  <div class="form-group row">
		                    ...
		                    <div class="col-sm-9">
		                  	...
		                  	<div class="form-group row">
			                    ...
			                    <div class="col-sm-9">
			                      <input type="text" class="form-control" name="banner_ad_url">
			                    </div>
		                  	</div>		                  	
		                  ...
		                  <div class="form-group row">
							...
							<div class="form-group row">
    							...
    							<div class="col-sm-9">
    								<input type="text" class="form-control" name="bg_color" placeholder="Hex code"  value="">
    							</div>
							</div>	
