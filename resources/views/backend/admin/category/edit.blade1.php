		              ...
		              <form class="form-horizontal" action="{{URL::to('admin/category/'.$category->id)}}" method="post" enctype="multipart/form-data">
		                ...
		                <div class="card-body">
		                  ...
		                  <div class="form-group row">
		                    ...
		                    <div class="col-sm-9">
		                      <textarea name="meta_des" class="form-control" rows="5">{{$category->meta_des}}</textarea>
		                    </div>
		                  </div>
...
<script src="http://localhost/binary/public/backend/plugins/jquery/jquery.min.js"></script>
<script>
