        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Manage Description Page Ads</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <tr>
	                ...
	                <td>
                  	...
                  	<td>
                        ...
                        <a href="{{URL::to('admin/ad/'.$item->id.'/edit')}}" title="Edit" style="float: left;margin-right: 10px;">
                            <button type="submit" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i>
                            </button>
                        </a>

                        @if($user->role_id == 0 )
                        <form action="{{URL::to('admin/ad/'.$item->id)}}" method="post">
                          @csrf
                          @method('DELETE')
