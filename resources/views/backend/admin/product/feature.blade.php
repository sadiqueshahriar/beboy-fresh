          ...
          <div class="card">
            ...
            <div class="card-header">
              ...
              <div class="row">
                ...
                <div class="col-md-4"><h3 class="card-title">Manage Home Product</h3></div><br><br>
            ...
            <div class="">
              ...
              <form class="form-horizontal product-details-form" action="{{URL::to('admin/save-feature-seq')}}" method="post" enctype="multipart/form-data">
                ...
                <ul id="sortable" class="mt-4">
                  ...
                  @foreach($features as $feature)
                    ...
                    <li class="ui-state-default p-4">
                      ...
                      <input type="hidden" name="product[{{$feature->id}}]" value="{{$feature->id}}">


                      <img src="{{ asset($feature->product_image_thumb) }}" alt="" style=" background: #fff;width: 130px;height: 60px;text-align: center;box-sizing: border-box;box-shadow: 6px 9px 11px -5px rgba(0,0,0,0.30); object-fit: cover;"> 

                      <span class="ui-icon ui-icon-arrowthick-2-n-s"></span>{{$feature->name}}
