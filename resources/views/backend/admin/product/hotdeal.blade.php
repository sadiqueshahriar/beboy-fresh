        ...
        <div class="col-md-12">
          ...
          <div class="card">
            ...
            <div class="">
              ...
              <form class="form-horizontal product-details-form" action="{{URL::to('admin/save-hotdeal-seq')}}" method="post" enctype="multipart/form-data">
                ...
                <ul id="sortable" class="mt-4">
                  ...
                  @foreach($hotdeals as $hotdeal)
                    ...
                    <li class="ui-state-default p-4">
                      ...
                      <input type="hidden" name="product[{{$hotdeal->id}}]" value="{{$hotdeal->id}}">


                      <img src="{{ asset($hotdeal->product_image_thumb) }}" alt="" style=" background: #fff;width: 130px;height: 60px;text-align: center;box-sizing: border-box;box-shadow: 6px 9px 11px -5px rgba(0,0,0,0.30); object-fit: cover;"> 

                      <span class="ui-icon ui-icon-arrowthick-2-n-s"></span>{{$hotdeal->name}}
