	            ...
	            <!-- Horizontal Form -->
		            <div class="card card-info">
		              <div class="card-header">
		                <h3 class="card-title">Add Pro Pro Category</h3>
		              </div>
		              <!-- /.card-header -->
		              <!-- form start -->
		              <form class="form-horizontal" action="{{URL::to('admin/proprocategory')}}" method="post" enctype="multipart/form-data">
		              	@csrf
		                <div class="card-body">
                          ...
                          <div class="form-group row">
		                    ...
		                    <div class="col-sm-9">
		                      <select name="pro_sub_category_id" id="pro_sub_category_id" class="form-control">
		                      	<option value="" selected disabled>Pro Sub Category</option>
		                  ...
		                  <div class="form-group row">
		                    <label for="inputEmail3" class="col-sm-3 col-form-label">Pro Pro Category Name</label>
		                    <div class="col-sm-9">
		                  ...
		                  <div class="form-group row">
		                    ...
		                    <div class="col-sm-9">
		                      <input type="text" class="form-control" name="slug" placeholder="Pro Sub Category Slug">
		                    </div>
		                  </div>			                  
		                  ...
		                  <div class="form-group row">
		                    ...
		                    <div class="col-sm-9">
		                      <input type="text" class="form-control" name="meta_keywords" data-role="tagsinput" id="tags">
		                    </div>
		                  </div>	
