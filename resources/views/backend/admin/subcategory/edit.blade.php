          	...
          	<div class="col-md-10 offset-2 mt-5">
	            ...
	            <!-- Horizontal Form -->
		            <div class="card card-info">
		              ...
		              <!-- /.card-header -->
		              <!-- form start -->
		              <form class="form-horizontal" action="{{URL::to('admin/subcategory/'.$subcategory->id)}}" method="post" enctype="multipart/form-data">
		                ...
		                <div class="card-body">
		                  ...
		                  <div class="form-group row">
		                    ...
		                    <div class="col-sm-9">
		                      <input type="text" class="form-control" name="slug" placeholder="SLug Name" required=""  value="{{$subcategory->slug}}">
		                    </div>
		                  </div>
						  <div class="form-group row">
		                    <label for="inputDescription" class="col-sm-3 col-form-label">Description</label>
		                    <div class="col-sm-12">
		                      <textarea name="description" id="description" class="textarea form-control" rows="5">{{$subcategory->description}}</textarea>
		                    </div>
		                  </div>
						  <div class="form-group row">
		                    <label for="inputDescription" class="col-sm-3 col-form-label">Sub Category Summary</label>
		                    <div class="col-sm-12">
		                      <textarea name="category_summary" id="category_summary" class="textarea form-control" rows="5">{{$subcategory->category_summary}}</textarea>
		                    </div>
		                  </div>
		                  ...
		                  <div class="form-group row">
		                    ...
		                    <div class="col-sm-9">
		                      <input type="text" class="form-control meta_input" name="meta_title" placeholder="Meta Title"  value="{{$subcategory->meta_title}}">
		                    </div>
		                  </div>			                  
		                  ...
		                  <div class="form-group row">
		                    ...
		                    <div class="col-sm-9">
		                      <textarea name="meta_des" class="form-control" rows="5" maxlength="180">{{$subcategory->meta_des}}</textarea>
		                    </div>
		                  </div>
		                  	...
		                  	<div class="form-group row">
			                    ...
			                    <div class="col-sm-9">
					                ...
					                <div class="form-group">
					                    <img src="{{ asset($subcategory->image) }}" alt="Image" style="width: 30%; margin-top: 8px">
